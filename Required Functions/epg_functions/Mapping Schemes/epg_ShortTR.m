function [ITs,PP_FAs,IT_FAs,Segment_Sizes] = epg_ShortTR(TRs,T1s,T2,ratios,Velocity,Angle,Diff_co,Train_Size,Segment_Factor)
...
%       saturation recovery module and alter the Delay Time (TD_SR). Fixed
%       TR = 1s and segmented in 4.
%
%	INPUT:
